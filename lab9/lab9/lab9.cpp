...
int cities[V][V] = {
    { INT_MAX, 6, 3, 8, 2, 14, 7, 9 },
    { 4, INT_MAX, 11, 25, 18, 12, 3, 14 },
    { 10, 7, INT_MAX, 5, 3, 16, 4, 6 },
    { 8, 4, 6, INT_MAX, 9, 11, 5, 10 },
    { 3, 9, 8, 12, INT_MAX, 6, 18, 2 },
    { 12, 6, 4, 11, 14, INT_MAX, 9, 5 },
    { 7, 3, 5, 6, 4, 2, INT_MAX, 8 },
    { 9, 11, 3, 10, 12, 4, 7, INT_MAX }
};
...
void Genetic_algo() {
    ...
    cout << "\nЛучший маршрут: " << population[0].gnome
...
int main() {
    ...
    do {
        cout << "\nМеню:\n";
        cout << "1. Изменить граф\n";
        cout << "2. Генетический алгоритм\n";
        cout << "3. Выход\n";
        cout << "Ваш выбор: ";
        cin >> choice;
        switch (choice) {
